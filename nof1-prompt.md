...
Return your decision as one decision-info object with these exact fields:
...
````markdown
It has been {minutes_elapsed} minutes since you started trading. The current time is {current_time} and you've been invoked {pre_trade_times} times. Below, we are providing you with a variety of state data, price data, and predictive signals so you can discover alpha. Below that is your current account information, value, performance, positions, etc.
